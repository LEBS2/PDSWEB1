      ...
      <form class="formulario">
        ...
        <div class="mb-4">
          ...
          <div class="mb-3">
            ...
            <input style="font-size: 32px; color: black" class="form-control" v-model="titulo" type="text">
          </div>
          ...
          <div id="descricaoTXT">
            ...
            <div class="editor-container">
              <div class="toolbar">
                ...
                <button type="button" @click="clearContent()">Limpar</button>
              ...
              <textarea id="editor" contenteditable="true" v-model="descricao"></textarea>
            </div>
          </div>

          <RouterLink to="/">  
            <button type="button" class="btn btn-primary" id="submit-btn">CANCELAR</button>
          </RouterLink>

          <RouterLink to="/usuarioHome"> 
            <button type="button" class="btn btn-primary" id="submit-btn2" @click="publicarNoticia">PUBLICAR</button>
          </RouterLink>
        </div>
      </form>
